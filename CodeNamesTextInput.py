...
class CodeNamesTextInput(enum.Enum):
   ...
   def label(self, language:Language):
      match language:
         case Language.FR:
            match self:
               case CodeNamesTextInput.GUESS_TEXT_INPUT:
                  return f"Mot à deviner :"
               case CodeNamesTextInput.SUGGEST_TEXT_INPUT:
                  return f"Indice :"
               case CodeNamesTextInput.NB_TRY_TEXT_INPUT:
...
def _get_guess_text_input(language:Language) -> interactions.TextInput:
    return interactions.TextInput(
       type=interactions.ComponentType.INPUT_TEXT,
        ...
        label=CodeNamesTextInput.GUESS_TEXT_INPUT.label(language),
        custom_id=CodeNamesTextInput.GUESS_TEXT_INPUT.value,
        required=True,
    )
...
def _get_suggest_text_input(language:Language) -> interactions.TextInput:
    return interactions.TextInput(
       type=interactions.ComponentType.INPUT_TEXT,
        style=interactions.TextStyleType.SHORT, 
        label=CodeNamesTextInput.SUGGEST_TEXT_INPUT.label(language),
        custom_id=CodeNamesTextInput.SUGGEST_TEXT_INPUT.value,
        required=True,
    )
...
def _get_nb_try_text_input(language:Language) -> interactions.TextInput:
    return interactions.TextInput(
       type=interactions.ComponentType.INPUT_TEXT,
        style=interactions.TextStyleType.SHORT, 
        label=CodeNamesTextInput.NB_TRY_TEXT_INPUT.label(language),
        custom_id=CodeNamesTextInput.NB_TRY_TEXT_INPUT.value,
